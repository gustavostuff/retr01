...
static R01sLevel gate2_or(R01sLevel a, R01sLevel b) {
...
static void hc32_reset(R01sEntity *e) {
    int i;
    for (i = 0; i < 4; i++) {
        r01s_entity_drive(e, HC32_GATES[i].y, R01S_LVL_Z);
    }
}

static void hc32_eval(R01sEntity *e) {
    int i;
    for (i = 0; i < 4; i++) {
        r01s_entity_drive(e, HC32_GATES[i].y,
                          gate2_or(r01s_entity_sense(e, HC32_GATES[i].a),
                                   r01s_entity_sense(e, HC32_GATES[i].b)));
    }
}

static void hc32_tick(R01sEntity *e) {
    (void)e;
}

static void hc32_destroy(R01sEntity *e) {
    (void)e;
}

static const R01sEntityVTable HC32_VT = {hc32_reset, hc32_eval, hc32_tick, hc32_destroy};
...
void r01s_sn74hc32_init(R01sSn74hc32 *chip, const char *refdes) {
    ...
    r01s_entity_init(&chip->base, &HC32_VT, "SN74HC32", refdes ? refdes : "U?");
    chip->base.impl = chip;
