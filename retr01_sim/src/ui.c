...
int r01s_ui_init(R01sUi *ui) {
    ...
    ui->drag_stick = -1;
    ui->drag_btn = -1;
    snprintf(ui->status, sizeof(ui->status), "islands A-E+G+H+I — drag empty / resize BR — SPACE run/pause");
    return 0;
}
...
void r01s_ui_draw(R01sUi *ui, SDL_Renderer *r) {
    ...
    font_draw(r, 8, 7, "RETR01 SIM  ISLANDS A-E+G+H+I+O+J", 200, 210, 220);
