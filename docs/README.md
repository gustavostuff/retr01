...
| [ic-comms-risks.md](ic-comms-risks.md) | Shared-bus / multi-clock risks, mitigations, play-path anti-patterns |
...
| [memory.md](memory.md) | CPU map, soft `$7Fxx`, MAP port, `.retr01` image, entity flash capacity |
| [software-api.md](software-api.md) | What an entity is, def size, C/ASM API, game modes |
| [sound.md](sound.md) | APU soft window, MCU-S2 PWM |
