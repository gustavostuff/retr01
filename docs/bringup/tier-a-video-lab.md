...
**SoT:** `docs/general/hardware.md`, `docs/general/video-graphics.md`, `docs/general/palette/`, `docs/ic_behavior/AD724.md`, `docs/ic_behavior/ATF22V10.md`, `docs/ic_behavior/AT27C256R.md`.
