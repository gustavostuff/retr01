...
**SoT:** `docs/general/hardware.md`, `docs/general/memory.md` (`$7F10-$7F12`), `docs/general/ic-comms-risks.md` (VRAM PHI2 interleave), `docs/ic_behavior/AS6C62256.md`, `docs/ic_behavior/74HC157.md`.
