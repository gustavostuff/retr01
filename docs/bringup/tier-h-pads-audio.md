...
**SoT:** `docs/general/hardware.md` (pads, S2), `docs/general/sound.md`, `docs/general/memory.md` (`$7F60`/`$7F61`, APU window), `docs/general/ic-comms-risks.md`, `docs/ic_behavior/AVR128DB28.md`, `docs/ic_behavior/ATtiny85.md`.
