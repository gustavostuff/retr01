...
Macrocell pressure (full design): scroll-Y + other registered work can approach **~21 of 30** macrocells across the three 22V10s. That budget is a hard limit. A **1-dot registered** color index is preferred if fit allows. See `docs/ic_behavior/ATF22V10.md`.
