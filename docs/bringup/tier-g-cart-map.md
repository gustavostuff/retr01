...
**SoT:** `docs/general/cartridge.md`, `docs/general/memory.md`, `docs/general/hardware.md` (cart edge / OE#), `docs/general/ic-comms-risks.md` (cart OE / saves), `docs/ic_behavior/SST39SF040.md`, `docs/ic_behavior/24C64.md`.
