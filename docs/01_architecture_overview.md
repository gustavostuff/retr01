...
```text
  ...
  |                                                |  +----------------------------+      | |
  |   +- VRAM INTERLEAVE + BUS ----------------+   |                                      | |
  |   |  HC157 HC157 HC157 HC157   [16] x4     |   |  +--------------+  20 MHz xtal       | |
  ...
  |                                                                                         |
  |   +- BG BEAM + FETCH GLUE --------------------------------------------------------+     |
  |   |  HC161 HC161 HC161 HC161  [16] x4  -> 341x262 dot clock ~5.37 MHz              |     |
  |   |                                                                               |     |
  |   |  HC573x6  scroll / slot banks / MAP addr  [20]     HC14 [14] reset Schmitt    |     |
  ...
  |   |  |  PRG / CHR / MAP (gated)   |      |   |  | 75R | | 75R | | 75R |  J S-VIDEO   |  |
  |   |  +----------------------------+      |   |  +-----+ +-----+ +-----+  J COMPOSITE |  |
  |   |  +--------------+  HC245 [20]        |   +---------------------------------------+  |
