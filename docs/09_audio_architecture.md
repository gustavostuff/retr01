...
The sequencer is driven entirely by the W65C02S **NMI** (~60×/s). **BGM** and **SFX** are two independent state machines. Main game logic runs between NMIs; audio work stays bounded per frame.
