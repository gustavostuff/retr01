...
| Composite encoder | **AD725ARZ**: RGB AC-coupled in, **CSYNC** on HSYNC, **NTSC**, **14.31818 MHz** 4FSC. COMP -> 75 ohm -> J9. Outside 32-IC count. **AV outs: RGBS + composite** (AD725 pins 9/11 unused). Chip is wide SOIC-16. **Board: DIP-16 + Proto Advantage PA0006** (see **U725**) |
