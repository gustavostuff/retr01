...
Logical playfield is **128x120**. Host FB is hardware **2x** (**256x240**). The Pi binary has **no debug window**. `retr01.sh` starts at **1x** integer (128x120 centered in desktop-fullscreen, CRT / RGB-Pi OS4 Ports). Home / Guide on a pad opens Reset, Quit, and 1x/2x, and mutes the speaker while that overlay is open.
