 ...
 *   Soft $FExx (HC573-zero): FE00/05/06/07/08/90-92 via soft_* API
...
typedef struct R01sAtmega1284p {
    ...
    /* Soft $FExx bank (HC573-zero). Same fields as fw/mcu1284/soft_fexx.h */
...
/* Soft $FExx (HC573-zero). port = low byte of $FExx. */
