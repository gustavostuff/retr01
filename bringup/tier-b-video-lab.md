...
- Don’t hang a partial CPU bus “for later” on Compositor pins without Hi-Z rules — causes fights when silicon is added.
- Don’t burn macrocells on full MAP/`SEL_SOFT*` decode yet; stub them.
- Don’t route HSYNC/VSYNC/CSYNC through the Compositor unless the JEDEC intentionally does; design keeps beam timing on Beam X/Y.
