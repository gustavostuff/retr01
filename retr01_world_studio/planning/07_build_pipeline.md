...
- [ ] RLE encode/decode — **B9 locked:** 960 tile + 240 attr bytes per screen ([06_data_formats.md](06_data_formats.md))
...
- Close **B9** documented in OPEN_QUESTIONS (locked) and [06_data_formats.md](06_data_formats.md)
