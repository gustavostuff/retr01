#ifndef DISCRETE_IC_VIDEO_SINK_H
#define DISCRETE_IC_VIDEO_SINK_H
 ...
 * Full raster (Retr01 bring-up / hardware.md): 341 dots x 262 lines. */
#define NS_VIDEO_W 256
#define NS_VIDEO_H 240
#define NS_RASTER_DOTS_X 341
#define NS_RASTER_DOTS_Y 262
 ...
 * Beam timing stays NS_RASTER_DOTS_X x NS_RASTER_DOTS_Y (HBLANK X>=256, VBLANK Y>=240).
...
/* Optional host palette (e.g. Retr01 AT27C256R kit). NULL = R3G3B2 expand. */
