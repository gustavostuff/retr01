...
3. Each world has **4 BG cells + 4 sprite cells**, **256 patterns** each. BG cells are chosen per live slot; sprite cell is a separate global latch. Mid-frame changes via **raster IRQ** (not sprite-0).
