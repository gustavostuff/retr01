...
|---------|------|-----------|--------|
| **Retr01-A** | Arcade cabinet motherboard | Through-hole (DIP) | **Initial / primary target** |
| **Retr01-C** | Home console | Through-hole (DIP) | Planned follow-on |
| **Retr01-H** | Handheld | Surface-mount (SMD) | Later miniaturized edition |
...
| Area | Spec |
|------|------|
| Resolution | 256×240 (32×30 × 8×8 tiles) |
...
| Audio | ATmega, **NES-style** (2× pulse, triangle, noise, DMC) |
