...
Retr01 is an MCU-assisted 8-bit system ready for arcade and console setups, plus Studio (cart editor) and Emu (standalone player and debug view) for editing and playtesting carts.
