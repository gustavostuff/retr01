...
Isolated hardware lab for [docs/bringup/tier-b-video-lab.md](../../../docs/bringup/tier-b-video-lab.md). Copied from Tier A, then changed only where the compositor lab differs. Tiers do not share netlist wiring. Engine: [`apps/netlist_sim/`](../../netlist_sim/).
