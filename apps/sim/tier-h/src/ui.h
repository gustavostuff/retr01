...
#define R01S_BOARD_MAX_CHIPS 192
#define R01S_UI_GAMEPAD_COUNT 2

/* Fixed HUD chrome -- board draws only in the center viewport.
 * Top/bottom debug bars removed: full window is the board view. */
#define R01S_UI_UNIT 8
#define R01S_UI_HUD_TOP 0
#define R01S_UI_HUD_BOTTOM 0
...
/* Soft netlist vs breadboard-gated wiring (matches R01S_BOARD_WIRE_*). */
#define R01S_WIRE_LIVE 0
#define R01S_WIRE_MANUAL 1
