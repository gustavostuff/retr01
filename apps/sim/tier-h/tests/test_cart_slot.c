...
int main(void) {
    ...
    expect_true(r01s_cart_slot_insert(&mgr, &mod, R01S_CART_SLOT_MOBO) == 0, "console insert");
    expect_true(r01s_cart_slot_insert(&mgr, &mod, R01S_CART_SLOT_MOBO) != 0, "second insert blocked");
    expect_true(r01s_cart_slot_remove(&mgr, R01S_CART_SLOT_MOBO) == 0, "console remove");
    expect_true(r01s_cart_slot_insert(&mgr, &mod, R01S_CART_SLOT_MOBO) == 0, "console insert again");
