...
**Preliminary Skidl export (not fab-ready):** `export_tier_h_netlist` plus [`scripts/skidl_from_tier_h.py`](../../scripts/skidl_from_tier_h.py). See [`docs/bringup/tier-h-skidl-export.md`](../../docs/bringup/tier-h-skidl-export.md). Illustrative PCB exploration only; motherboard PCB is not ready for production.
