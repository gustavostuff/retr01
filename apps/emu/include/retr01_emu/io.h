 ...
 * $7F24 / $7F72 assert CPU_RDY (R01_RDY_*_HOLDS). Raster IRQ still later.
 */
typedef struct R01eIo {
    uint8_t ctrl;        /* $7F00 Soft0 */
    uint8_t status;      /* $7F01 */
    uint8_t scroll_x;    /* $7F02 hard */
    uint8_t scroll_y;    /* $7F03 hard */
    ...
    /* Cart save mailbox $7F22-$7F24 Soft2 (docs/memory.md). */
    uint8_t cartee_hi;
    uint8_t cartee_lo;
