...
typedef struct R01eVideo {
    ...
    int bg0_origin_col; /* min present BG0 col (for wrap remap) */
    int bg0_origin_row;
    int bg0_wrap_x; /* cart FLAG_BG0_WRAP_X: modulo-tile sample, period n/n rate */
    int bg0_wrap_y; /* cart FLAG_BG0_WRAP_Y: modulo-tile sample, period n/n rate */
    ...
    int l1_origin_y;
    int l0_cam_x; /* proportional or $7F06/$7F07 pixel scroll */
    int l0_cam_y;
    int bg0_scroll_manual; /* 1 after CPU writes $7F06/$7F07 */
...
/* Copy one global palette row (BG+SPR) into the active $7F08/$7F09 buffer. */
