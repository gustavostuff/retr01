...
#define UI_WORLDS_TAB_STACK_H UI_TAB_PAGER_H
...
#define UI_BANKS_PLANE_GLOBAL_BG UI_BANKS_PLANE_BG
#define UI_BANKS_PLANE_GLOBAL_SPR UI_BANKS_PLANE_SPR
#define UI_BANKS_N 16
#define UI_BANKS_TAB_W 8
...
#define UI_PROJ_IO_MAX_ENTRIES 96
typedef struct UiProjectIo {
    int mode; /* UI_PROJ_IO_* from project_io.h */
    char name[R01_NAME_MAX];
    char dir[R01_PATH_MAX];
    char entries[UI_PROJ_IO_MAX_ENTRIES][256];
    int entry_is_dir[UI_PROJ_IO_MAX_ENTRIES];
    int entry_count;
    int sel;
    int scroll;
